...
const contactInfo = [];
graduates.forEach(function(graduates) {
    contactInfo.push(graduates.first_name);
    contactInfo.push(graduates.email);
...
const uni = [];
graduates.forEach(function(graduates) {
    if(graduates.name == "Uni"){
      uni.push(graduates.name)
    }
})
...
*/
const lowerCase = animalNames.map(function(x) { return x.toLowerCase(); });
